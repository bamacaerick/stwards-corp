...
<main id="content" role="main">
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        <header class="header">
            ...
            <a href="<?php echo esc_url( get_permalink( $post->post_parent ) ); ?>" title="<?php printf( esc_attr__( 'Return to %s', 'generic' ), esc_attr( get_the_title( $post->post_parent ), 1 ) ); ?>" rev="attachment">
